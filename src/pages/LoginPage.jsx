  ...
  return (
    <div className="login-wrap">
      <div className="login-card">
        <div className="login-logo">⚡ Insighta</div>
        <p className="login-sub">Profile Analytics Dashboard</p>

        <div className="login-features">
          <span className="login-feature-chip">📊 Real-time metrics</span>
          <span className="login-feature-chip">🔍 Smart search</span>
          <span className="login-feature-chip">🌍 Country insights</span>
        </div>

        <button id="github-login-btn" className="github-btn" onClick={handleGitHubLogin}>
          <GitHubIcon />
          Continue with GitHub
        </button>

        <p className="login-footer">
          <ShieldIcon /> Secure OAuth 2.0 via GitHub.<br />
          No passwords stored. Tokens never exposed to JavaScript.
        </p>
      </div>
    </div>
  );
